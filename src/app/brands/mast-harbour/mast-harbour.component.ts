...
@Component({
  selector: 'app-mast-harbour',
  templateUrl: './mast-harbour.component.html',
  styleUrls: ['./mast-harbour.component.css']
})
export class MastHarbourComponent implements OnInit {
