...
@Component({
  selector: 'app-dennis-lingo',
  templateUrl: './dennis-lingo.component.html',
  styleUrls: ['./dennis-lingo.component.css']
})
export class DennisLingoComponent implements OnInit {
